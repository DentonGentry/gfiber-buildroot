...
noconfig_targets:=menuconfig nconfig gconfig xconfig config oldconfig randconfig \
	...
	source-check print-version %_defconfig_rebuild
...
ifneq ($(BR2_TARGET_GENERIC_PLATFORM_NAME),"")
	$(BR2_ROOTFS_POST_BUILD_SCRIPT) $(TARGET_DIR) $(TARGET_SKELETON) $(BR2_TARGET_GENERIC_PLATFORM_NAME) \
		"$(BR2_PACKAGE_GOOGLE_PROD)" "$(BR2_PACKAGE_GOOGLE_UNSIGNED)"
else
