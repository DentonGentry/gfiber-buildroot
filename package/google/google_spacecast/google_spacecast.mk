...
define GOOGLE_SPACECAST_PROTOS
	...
	$(call GOOGLE_SPACECAST_GEN_PROTO,local_database)
	$(call GOOGLE_SPACECAST_GEN_PROTO,monlog)
	...
	# This command fixes the proto package names in import paths
	# generated by third party protoc for the Go Language.
	# Generated import paths are in the form of
	# import "mypackage/myproto.pb" and it should be
	# import "mypackage/myproto_proto"
	find $(@D)/proto -name "*.pb.go" | xargs sed -i s/\.pb/_proto/
endef
...
define GOOGLE_SPACECAST_MOCKS
	...
	$(call GOOGLE_SPACECAST_GEN_MOCK,spacecast/appliance/updateengine/exec,Cmd)
	$(call GOOGLE_SPACECAST_GEN_MOCK,spacecast/appliance/updateengine/exec,CmdCreator)
	$(call GOOGLE_SPACECAST_GEN_MOCK,spacecast/appliance/updateengine/time,Timer)
	$(call GOOGLE_SPACECAST_GEN_MOCK,spacecast/appliance/updateengine/time,TimerCreator)
