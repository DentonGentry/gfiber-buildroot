...
define GOOGLE_BUFFET_INSTALL_TARGET_CMDS
	...
	mkdir -p $(TARGET_DIR)/chroot/chromeos/etc/buffet/commands && \
	$(INSTALL) -m 0755 -D package/google/google_buffet/test.json $(TARGET_DIR)/chroot/chromeos/etc/buffet/commands
