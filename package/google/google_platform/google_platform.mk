...
ifeq ($(BR2_PACKAGE_GOOGLE_PLATFORM_QUANTENNA),y)
BUILD_QUANTENNA=y
endif
...
GPLAT_BASEMAKE = \
	...
	BUILD_QUANTENNA=$(BUILD_QUANTENNA) \
...
define GOOGLE_PLATFORM_INSTALL_TARGET_CMDS
	...
	$(if $(BR2_PACKAGE_GOOGLE_PLATFORM_CONNECTION_MANAGER),$(INSTALL) -m 0755 -D package/google/google_platform/S51conman $(TARGET_DIR)/etc/init.d/)
