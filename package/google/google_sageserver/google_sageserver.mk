...
ifeq ($(BR2_mipsel),y)
	...
	STANDARD_JAR_PATH=$(GOOGLE_SKELMIR_DIR)/mipsel-5k-linux-uclibc/development/lib/
else ifeq ($(BR2_arm),y)
	GOOGLE_SAGESERVER_DEPENDENCIES += google_skelmir
	STANDARD_JAR_PATH=$(GOOGLE_SKELMIR_DIR)/arm-v7l-linux-gnueabi/development/lib/
else
	STANDARD_JAR_PATH=jars/
endif
