...
define BCM_MIRACAST_BUILD_CMDS
	...
	$(BCM_MAKE_ENV) $(MAKE1) $(BCM_MAKEFLAGS) VERBOSE=y HAS_WIFI_BUILT=y NETAPP_USB=n NETAPP_WIFI_WPS=n NETAPP_SSDP=n NETAPP_ZEROCONF=n NETAPP_DATABASE=n AARDVARK_DRIVER_VERSION=wifi WIFI_SRC_PKG=$(@D)/broadcom/netapp/netapp/wlan/broadcom/aardvark.tgz APPLIBS_TOP=$(@D) \
		-C $(@D)/common netapp
endef
